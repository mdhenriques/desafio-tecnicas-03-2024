...
public class LivroIHM extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        umlivro.setTitulo(tf1.getText());
        umlivro = LivroDAL.consultaLivroPorTitulo(umlivro.getTitulo());
        if (Erro.getErro())
            javax.swing.JOptionPane.showMessageDialog(null,Erro.getMens());
        else
            {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        umlivro.setTitulo(tf1.getText());
        LivroDAL.excluiLivro(umlivro.getTitulo());
        if (Erro.getErro()) {
            javax.swing.JOptionPane.showMessageDialog(null, Erro.getMens());
        } else {
            javax.swing.JOptionPane.showMessageDialog(null, "Livro excluido com sucesso!!");
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        umlivro.setAnoEdicao(tf4.getText());
        umlivro.setLocalizacao(tf5.getText());
        LivroDAL.alteraLivroPorTitulo(umlivro.getTitulo(), umlivro);
        if (Erro.getErro())
            javax.swing.JOptionPane.showMessageDialog(null, Erro.getMens());
        else
